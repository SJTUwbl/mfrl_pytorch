...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, choices={'mfac', 'mfq'}, help='choose an algorithm from the preset', required=True)
    parser.add_argument('--oppo', type=str, choices={'mfac', 'mfq'}, help='indicate the opponent model')
    ...
    runner = tools.Runner(env, handles, args.map_size, args.max_steps, models, battle, render_every=0)
